...
class MCP23017(object):
    def __init__(self, config):
        ...
        self._ppins.register_chip("mcp23017_" + self._name, self)
        ...
        if interrupt_pin is not None:
            ...
            buttons.register_button_push(interrupt_pin, self._button_handler)
    ...
    def _connect(self):
        ...
        self._button_handler(eventtime)
...
#         return self._mcu
    ...
    def _button_handler(self, eventtime):
        params = self._i2c.i2c_read([REG_GPIO], 2)
        response = bytearray(params['response'])
        state = (response[1] << 8) | response[0]
